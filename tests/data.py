...
OCDS_TITLES_COMBINED = {
    ...
    "/contracts/implementation/transactions/0/date": "Transaction Information " "Date",
    ...
    "selection": {
        "tenders": {
            ...
            "headers": {
                ...
                "/tender/hasEnquiries": "tender_has_enquiries?",
                "/tender/value/amount": "value_amount",
                "/tender/awardCriteria": "tender_award_criteria",
                "/tender/tenderers/0/id": "organization_reference_id",
                "/tender/value/currency": "value_currency",
                "/tender/items/0/unit/id": "unit_id",
                "/tender/minValue/amount": "minimum_value_amount",
                "/tender/items/0/quantity": "item_quantity",
                "/tender/items/0/unit/uri": "unit_uri",
                "/tender/submissionMethod": "tender_submission_method",
                "/tender/tenderers/0/name": "organization_reference_name",
                "/tender/items/0/unit/name": "unit_name",
                "/tender/minValue/currency": "minimum_value_currency",
                "/tender/numberOfTenderers": "tender_number_of_tenderers",
                "/tender/procurementMethod": "tender_procurement_method",
                "/tender/procuringEntity/id": "procuring_entity_organization_id",
                "/tender/awardPeriod/endDate": "evaluation_and_award_period_end_date",
                "/tender/eligibilityCriteria": "tender_eligibility_criteria",
                "/tender/items/0/description": "item_description",
                "/tender/items/0/unit/scheme": "unit_scheme",
                "/tender/awardCriteriaDetails": "tender_award_criteria_details",
                "/tender/procuringEntity/name": "procuring_entity_organization_name",
                "/tender/tenderPeriod/endDate": "tender_period_end_date",
                "/tender/awardPeriod/startDate": "evaluation_and_award_period_start_date",
                "/tender/enquiryPeriod/endDate": "enquiry_period_end_date",
                "/tender/contractPeriod/endDate": "contract_period_end_date",
                "/tender/tenderPeriod/startDate": "tender_period_start_date",
                "/tender/enquiryPeriod/startDate": "enquiry_period_start_date",
                "/tender/mainProcurementCategory": "tender_main_procurement_category",
                "/tender/submissionMethodDetails": "tender_submission_method_details",
                "/tender/contractPeriod/startDate": "contract_period_start_date",
                "/tender/procurementMethodDetails": "tender_procurement_method_details",
                "/tender/awardPeriod/maxExtentDate": "evaluation_and_award_period_maximum_extent",
                "/tender/items/0/classification/id": "classification_id",
                "/tender/items/0/unit/value/amount": "value_amount",
                "/tender/awardPeriod/durationInDays": "evaluation_and_award_period_duration_(days)",
                "/tender/items/0/classification/uri": "classification_uri",
                "/tender/procurementMethodRationale": "tender_procurement_method_rationale",
                "/tender/tenderPeriod/maxExtentDate": "tender_period_maximum_extent",
                "/tender/enquiryPeriod/maxExtentDate": "enquiry_period_maximum_extent",
                "/tender/items/0/unit/value/currency": "value_currency",
                "/tender/tenderPeriod/durationInDays": "tender_period_duration_(days)",
                "/tender/contractPeriod/maxExtentDate": "contract_period_maximum_extent",
                "/tender/enquiryPeriod/durationInDays": "enquiry_period_duration_(days)",
                "/tender/contractPeriod/durationInDays": "contract_period_duration_(days)",
                "/tender/items/0/classification/scheme": "classification_scheme",
                "/tender/additionalProcurementCategories": "tender_additional_procurement_categories",
                "/tender/items/0/classification/description": "classification_description",
                "/tender/items/0/additionalClassifications/0/id": "classification_id",
                "/tender/items/0/additionalClassifications/0/uri": "classification_uri",
                "/tender/items/0/additionalClassifications/0/scheme": "classification_scheme",
                "/tender/items/0/additionalClassifications/0/description": "classification_description",
            },
            "name": "Tenders",
        },
        "tenders_items": {
